...
class GLUEDataModule(LightningDataModule):
    ...
    task_text_field_map = {'cola': ['sentence']}

    glue_task_num_labels = {'cola': 2}
...
trainer.save_checkpoint("classification_model.pt")
print(time.time())
print("Time to validate:")
val_start_time = time.time()
trainer.validate()
print(time.time())
print("--- %s seconds for validation---" % (time.time() - val_start_time))
